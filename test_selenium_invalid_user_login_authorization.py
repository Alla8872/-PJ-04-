...
def test_invalid_user_login_authorization(selenium):
    """ Авторизация пользователя по некорректному email и корректному паролю"""
    ...
    search_input_username.send_keys("allapod")
    time.sleep(5)
    ...
    selenium.save_screenshot('test11.png')
