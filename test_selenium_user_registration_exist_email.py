...
def test_user_registration(selenium):
    """Регистрация пользователя по e-mail, привязанному к имеющейся учетной записи"""
    ...
    search_input_password_confirm.send_keys("232323qwertyQ1")
